...
<div class="container">
		...
		<tbody>
			...
			<?php foreach($articles as $article): ?>
				<tr class="techSpecRow">
					...
					<td class="span3">
						Quantité : 
						<a href="/../accueil/deleteArticlePanier/<?php echo $article['id']; ?>" title="Soustraire"><img class="icon-plus" src="/img/moins.png"> </a>
						[ <?php echo $this->Session->read('Panier.'.$article['id']); ?> ]
						<a href="/../accueil/addArticlePanier/<?php echo $article['id']; ?>" title="Ajouter"> <img class="icon-plus" src="/img/plus.png"></a>
						-
						<a href="/../accueil/deleteArticlesPanier/<?php echo $article['id']; ?>" title="Supprimer"> <img class="icon-plus" src="/img/croix.png"></a>
					</td>
	...
	<?php if($this->Session->read('nbArticlePanier.nb')) : ?>
		<a href="/../achat"><button class="success">Acheter</button></a>
	<?php endif; ?>
	</div>
</div>